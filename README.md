...
<p align="center">
  <em>aprender 0.69.1 (TODO-CELL:release-date) — <strong>what changes for cookbook users</strong>. Mixture-of-experts Qwen3 (30B-A3B, Coder-30B-A3B) runs on CUDA through one dispatch on every verb (<a href="https://github.com/paiml/aprender/issues/3714">#3714</a>, <a href="https://github.com/paiml/aprender/issues/3987">#3987</a>). <code>--thinking on|off</code> on <code>apr run</code>, <code>chat</code> and <code>code</code> (<a href="https://github.com/paiml/aprender/issues/3723">#3723</a>). The model&#39;s own chat template is rendered on every path (<a href="https://github.com/paiml/aprender/issues/3990">#3990</a>). New CUDA quant kernels: IQ4_NL, IQ3_S, IQ2_S, IQ3_XXS, Q2_K, BF16, Q5_1. <code>apr capability --json</code> prints what the binary runs, and where. Certified under an operator emergency scope (a CRUX smoke on both GPU hosts; the full model ladder runs nightly). Known issue: Qwen3.5-0.8B with thinking ON (<a href="https://github.com/paiml/aprender/issues/4030">#4030</a>; <code>apr</code> warns at load). The first <code>apr</code>-binary recipes are in <a href="recipes/README.md"><code>recipes/</code></a>.</em>
</p>
