//! # Cli Batch Commands
//!
//! Demonstrate alimentar CLI batch operations end-to-end.
//!
//! Contract: contracts/recipe-iiur-v1.yaml
//! Citation: Hahn, R. (1992). The C++ Programming Language: Reading. Addison-Wesley.  N/A -- see PMAT-066
//!
//! Run with: cargo run --example cli_batch_commands
//!
