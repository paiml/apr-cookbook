//! # Dataloader Batching
//!
//! DataLoader batching, shuffling, and drop-last semantics.
//!
//! Contract: contracts/recipe-iiur-v1.yaml
//! Citation: Paszke, A. et al. (2019). PyTorch: An Imperative Style, High-Performance Deep Learning Library. NeurIPS. arXiv:1912.01703
//!
//! Run with: cargo run --example dataloader_batching
//!
