//! # Transforms Pipeline
//!
//! Compose multiple alimentar transforms into a single pipeline.
//!
//! Contract: contracts/recipe-iiur-v1.yaml
//! Citation: Halevy, A., Norvig, P., Pereira, F. (2009). The Unreasonable Effectiveness of Data. IEEE Intelligent Systems 24(2). DOI: 10.1109/MIS.2009.36
//!
