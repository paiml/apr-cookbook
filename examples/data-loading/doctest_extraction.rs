//! # Doctest Extraction
//!
//! Extract executable examples from doc comments via DocTestParser.
//!
//! Contract: contracts/recipe-iiur-v1.yaml
//! Citation: Beck, K. (2002). Test Driven Development: By Example. Addison-Wesley. ISBN: 978-0321146533
//!
//! Run with: cargo run --example doctest_extraction
//!
