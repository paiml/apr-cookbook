//! # Hub Publishing
//!
//! Publish a dataset to the HuggingFace Hub via alimentar's hub adapter.
//!
//! Contract: contracts/recipe-iiur-v1.yaml
//! Citation: Lhoest, Q. et al. (2021). Datasets: A Community Library for Natural Language Processing. EMNLP. arXiv:2109.02846
//!
//! Run with: cargo run --example hub_publishing
//!
...
mod quality_grades {
    pub(super) const GRADE_A: f64 = 95.0;
    pub(super) const GRADE_B: f64 = 85.0;
    pub(super) const GRADE_C: f64 = 70.0;
}
...
mod chrono {
    ...
    impl Utc {
        ...
        pub(super) fn format(&self, _: &str) -> &'static str {
            "2025-11-29"
        }
    }
}
