//! # Tui Viewer
//!
//! Terminal UI for browsing dataset rows interactively.
//!
//! Contract: contracts/recipe-iiur-v1.yaml
//! Citation: Curses (1977). System V curses. UNIX Programmer's Manual.  N/A -- see PMAT-066
//!
//! Run with: cargo run --example tui_viewer
//!
