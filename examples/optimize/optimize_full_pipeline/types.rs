...
pub const D_OUT: usize = 32;
pub const RANK: usize = 8;
pub const ALPHA: f32 = 8.0;
...
pub fn det_weights(size: usize, seed: u64) -> Vec<f32> {
    (0..size)
        .map(|i| {
...
pub fn gen_data(n: usize, d_in: usize, d_out: usize, seed: u64) -> (Vec<Vec<f32>>, Vec<Vec<f32>>) {
...
pub fn lora_forward(layer: &LoRALayer, x: &[f32], d_out: usize, d_in: usize) -> Vec<f32> {
...
pub fn stage_finetune(base_weights: Vec<f32>, ctx: &mut RecipeContext) -> Vec<f32> {
...
pub fn stage_prune(weights: &[f32], target_sparsity: f32) -> Vec<f32> {
    println!(
...
pub fn stage_distill(ctx: &mut RecipeContext) {
...
pub fn stage_merge(finetuned_weights: &[f32], ctx: &mut RecipeContext) -> Vec<f32> {
...
pub fn stage_quantize(weights: &[f32], ctx: &mut RecipeContext) -> Vec<f32> {
