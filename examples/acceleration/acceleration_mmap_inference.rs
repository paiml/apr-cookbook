...
impl MmapView {
    ...
    fn read_range(&mut self, offset: usize, len: usize) -> &[u8] {
    ...
    fn page_report(&self, tensors: &[TensorRecord]) -> Vec<PageAccess> {
