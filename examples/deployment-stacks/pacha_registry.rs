//! # Pacha Registry -- Sovereign deployment recipe loader
//!
//! Loads the deployment recipe `recipes/pacha-registry.yaml`, validates its schema, and
...
//!
//! Run with: cargo run --example pacha_registry
//!
...
const RECIPE_YAML: &str = include_str!("recipes/pacha-registry.yaml");

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("pacha_registry")?;
