//! # Whisper Apr Asr -- Sovereign deployment recipe loader
//!
//! Loads the deployment recipe `recipes/whisper-apr-asr.yaml`, validates its schema, and
...
//!
//! Run with: cargo run --example whisper_apr_asr
//!
...
const RECIPE_YAML: &str = include_str!("recipes/whisper-apr-asr.yaml");

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("whisper_apr_asr")?;
