//! # Entrenar Train -- Sovereign deployment recipe loader
//!
//! Loads the deployment recipe `recipes/entrenar-train.yaml`, validates its schema, and
...
//!
//! Run with: cargo run --example entrenar_train
//!
...
const RECIPE_YAML: &str = include_str!("recipes/entrenar-train.yaml");

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("entrenar_train")?;
