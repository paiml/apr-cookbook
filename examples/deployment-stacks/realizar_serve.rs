//! # Realizar Serve -- Sovereign deployment recipe loader
//!
//! Loads the deployment recipe `recipes/realizar-serve.yaml`, validates its schema, and
...
//!
//! Run with: cargo run --example realizar_serve
//!
...
const RECIPE_YAML: &str = include_str!("recipes/realizar-serve.yaml");

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("realizar_serve")?;
