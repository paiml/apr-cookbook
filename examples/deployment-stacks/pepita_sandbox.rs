//! # Pepita Sandbox -- Sovereign deployment recipe loader
//!
//! Loads the deployment recipe `recipes/pepita-sandbox.yaml`, validates its schema, and
...
//!
//! Run with: cargo run --example pepita_sandbox
//!
...
const RECIPE_YAML: &str = include_str!("recipes/pepita-sandbox.yaml");

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("pepita_sandbox")?;
