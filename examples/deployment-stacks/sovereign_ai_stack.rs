//! # Sovereign Ai Stack -- Sovereign deployment recipe loader
//!
//! Loads the deployment recipe `recipes/sovereign-ai-stack.yaml`, validates its schema, and
...
//!
//! Run with: cargo run --example sovereign_ai_stack
//!
...
const RECIPE_YAML: &str = include_str!("recipes/sovereign-ai-stack.yaml");

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("sovereign_ai_stack")?;
