//! # Alimentar Ingest -- Sovereign deployment recipe loader
//!
//! Loads the deployment recipe `recipes/alimentar-ingest.yaml`, validates its schema, and
...
//!
//! Run with: cargo run --example alimentar_ingest
//!
...
const RECIPE_YAML: &str = include_str!("recipes/alimentar-ingest.yaml");

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("alimentar_ingest")?;
