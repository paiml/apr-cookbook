//! # Jetson Edge Base -- Sovereign deployment recipe loader
//!
//! Loads the deployment recipe `recipes/jetson-edge-base.yaml`, validates its schema, and
...
//!
//! Run with: cargo run --example jetson_edge_base
//!
...
const RECIPE_YAML: &str = include_str!("recipes/jetson-edge-base.yaml");

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("jetson_edge_base")?;
