//! # Trueno Db Analytics -- Sovereign deployment recipe loader
//!
//! Loads the deployment recipe `recipes/trueno-db-analytics.yaml`, validates its schema, and
...
//!
//! Run with: cargo run --example trueno_db_analytics
//!
...
const RECIPE_YAML: &str = include_str!("recipes/trueno-db-analytics.yaml");

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("trueno_db_analytics")?;
