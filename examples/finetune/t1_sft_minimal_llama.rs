...
//!
//! Demonstrates the **t1_sft_minimal_llama** recipe per
//! `docs/specifications/fine-tuning-cookbook.md` v1.2.0 (PMAT-331).
//!
//! ## Mirror
//!
//! - Ludwig: examples/getting_started/
//! - Unsloth: nb/Llama3.1_(8B)-Alpaca.ipynb
//! - apr-native: false
//!
//! ## Falsifiable claim
//!
//! Training loss decreases over 1 epoch (100 SFT examples) for Llama-tiny.
//!
//! IIUR Contract: contracts/recipe-iiur-v1.yaml
//! Provable-contract: contracts/finetune-t1-sft-minimal-llama-v1.yaml
//! Citation: Touvron et al. (2023). LLaMA. arXiv:2302.13971
//!
//! Run with: cargo run --example t1_sft_minimal_llama
//!
//! Added by PMAT-331.
...
const FIXTURE: &str = "tests/fixtures/finetune/t1_sft_minimal_llama/data.jsonl";

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("t1_sft_minimal_llama")?;
