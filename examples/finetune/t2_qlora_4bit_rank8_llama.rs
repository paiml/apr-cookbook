//! # Tier 2.2 — QLoRA — Llama 4-bit + rank-8
//!
//! Falsifier: 4-bit base + rank-8 LoRA: VRAM peak ≤ 0.3× of FP16
//!
//! Run with: cargo run --example t2_qlora_4bit_rank8_llama
...
fn main() -> Result<()> {
    let _ctx = RecipeContext::new("t2_qlora_4bit_rank8_llama")?;
