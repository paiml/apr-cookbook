//! # Tier 1.4 — Tabular classification — 3class
//!
//! Falsifier: 3-class macro-F1 ≥ 0.95 on well-separated synthetic.
//!
//! Run with: cargo run --example t1_tabular_3class

use apr_cookbook::finetune::tabular_classification as tc;
use apr_cookbook::recipe::RecipeContext;
use apr_cookbook::Result;

const FIXTURE: &str = "tests/fixtures/finetune/t1_tabular_3class/data.jsonl";
const N_CLASSES: u32 = 3;
const N_FEATURES: usize = 2;
const F1_FLOOR: f64 = 0.95;

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("t1_tabular_3class")?;
    ...
    println!("✓ 3class NCM: macro-F1={f1:.4} (floor {F1_FLOOR})");
