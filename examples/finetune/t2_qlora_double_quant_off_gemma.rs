//! # Tier 2.2 — QLoRA — Gemma 4-bit no double-quant
//!
//! Falsifier: double-quant=off on Gemma matches single-quant accuracy ± 0.1 perplexity
//!
//! Run with: cargo run --example t2_qlora_double_quant_off_gemma
...
const RANK: u32 = 16;
const N_BASE_PARAMS: u64 = 2000000000;
const LORA_TRAINABLE: u64 = 4194304;
const DOUBLE_QUANT: bool = false;

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("t2_qlora_double_quant_off_gemma")?;
