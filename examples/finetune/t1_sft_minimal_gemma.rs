...
//!
//! Demonstrates the **t1_sft_minimal_gemma** recipe per
//! `docs/specifications/fine-tuning-cookbook.md` v1.2.0 (PMAT-331).
//!
//! ## Mirror
//!
//! - Ludwig: examples/getting_started/
//! - Unsloth: nb/Gemma3.1_(8B)-Alpaca.ipynb
//! - apr-native: false
//!
//! ## Falsifiable claim
//!
//! Training loss decreases over 1 epoch (100 SFT examples) for Gemma-tiny.
//!
//! IIUR Contract: contracts/recipe-iiur-v1.yaml
//! Provable-contract: contracts/finetune-t1-sft-minimal-gemma-v1.yaml
//! Citation: Gemma Team (2024). Gemma. arXiv:2403.08295
//!
//! Run with: cargo run --example t1_sft_minimal_gemma
//!
//! Added by PMAT-331.
...
const FIXTURE: &str = "tests/fixtures/finetune/t1_sft_minimal_gemma/data.jsonl";

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("t1_sft_minimal_gemma")?;
