...
//!
//! Demonstrates the **t1_sft_minimal_qwen** recipe per
//! `docs/specifications/fine-tuning-cookbook.md` v1.2.0 (PMAT-331).
//!
//! ## Mirror
//!
//! - Ludwig: examples/getting_started/
//! - Unsloth: nb/Qwen3.1_(8B)-Alpaca.ipynb
//! - apr-native: false
//!
//! ## Falsifiable claim
//!
//! Training loss decreases over 1 epoch (100 SFT examples) for Qwen-tiny.
//!
//! IIUR Contract: contracts/recipe-iiur-v1.yaml
//! Provable-contract: contracts/finetune-t1-sft-minimal-qwen-v1.yaml
//! Citation: Yang et al. (2024). Qwen2 Technical Report. arXiv:2407.10671
//!
//! Run with: cargo run --example t1_sft_minimal_qwen
//!
//! Added by PMAT-331.
...
const FAMILY: &str = "qwen";
const FIXTURE: &str = "tests/fixtures/finetune/t1_sft_minimal_qwen/data.jsonl";

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("t1_sft_minimal_qwen")?;
