//! # Tier 1.4 — Tabular classification — 7class
//!
//! Falsifier: 7-class macro-F1 ≥ 0.7 on well-separated synthetic.
//!
//! Run with: cargo run --example t1_tabular_7class

use apr_cookbook::finetune::tabular_classification as tc;
use apr_cookbook::recipe::RecipeContext;
use apr_cookbook::Result;

const FIXTURE: &str = "tests/fixtures/finetune/t1_tabular_7class/data.jsonl";
const N_CLASSES: u32 = 7;
const N_FEATURES: usize = 3;
const F1_FLOOR: f64 = 0.7;

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("t1_tabular_7class")?;
    ...
    println!("✓ 7class NCM: macro-F1={f1:.4} (floor {F1_FLOOR})");
