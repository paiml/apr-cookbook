//! # Tier 2.2 — QLoRA — Qwen3 4-bit + double-quant
//!
//! Falsifier: double-quant on Qwen3 reduces quantization-state memory by ≥ 0.4 bits/param
//!
//! Run with: cargo run --example t2_qlora_double_quant_qwen
...
const RANK: u32 = 16;
const N_BASE_PARAMS: u64 = 4000000000;
const LORA_TRAINABLE: u64 = 4194304;
const DOUBLE_QUANT: bool = true;

fn main() -> Result<()> {
    let _ctx = RecipeContext::new("t2_qlora_double_quant_qwen")?;
