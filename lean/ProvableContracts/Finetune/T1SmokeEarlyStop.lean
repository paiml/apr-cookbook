-- Theorems for `contracts/finetune-t1-smoke-early-stop-v1.yaml`.
namespace ProvableContracts.Finetune.T1SmokeEarlyStop
...
end ProvableContracts.Finetune.T1SmokeEarlyStop
