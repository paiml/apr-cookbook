-- Theorems for `contracts/finetune-t1-eval-accuracy-v1.yaml`.
namespace ProvableContracts.Finetune.T1EvalAccuracy
...
end ProvableContracts.Finetune.T1EvalAccuracy
