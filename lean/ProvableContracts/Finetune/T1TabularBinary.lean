-- Theorems for `contracts/finetune-t1-tabular-binary-v1.yaml`.
namespace ProvableContracts.Finetune.T1TabularBinary
...
end ProvableContracts.Finetune.T1TabularBinary
