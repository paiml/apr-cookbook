-- Theorems for `contracts/finetune-t1-tabular-3class-v1.yaml`.
namespace ProvableContracts.Finetune.T1TabularClass3class
...
end ProvableContracts.Finetune.T1TabularClass3class
