-- Theorems for `contracts/inference-whisper-smoke-v1.yaml`.
--
-- Whisper is speech-only; the architecture-demos contract delegates
...
namespace ProvableContracts.ArchitectureDemos.Whisper
...
end ProvableContracts.ArchitectureDemos.Whisper
