-- Theorems for `contracts/inference-gpt2-smoke-v1.yaml`.
--
-- GPT-2 short-name discriminator. The smoke recipe models `smoke()` and `forward_sim()`
-- as pure functions of their inputs; determinism and totality are
-- derivable from referential transparency.

namespace ProvableContracts.ArchitectureDemos.Gpt2
...
end ProvableContracts.ArchitectureDemos.Gpt2
