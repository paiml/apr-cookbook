-- Theorems for `contracts/inference-falcon_h1-smoke-v1.yaml`.
--
-- Falcon-H1 hybrid SSM discriminator. The smoke recipe models `smoke()` and `forward_sim()`
-- as pure functions of their inputs; determinism and totality are
-- derivable from referential transparency.

namespace ProvableContracts.ArchitectureDemos.FalconH1
...
end ProvableContracts.ArchitectureDemos.FalconH1
