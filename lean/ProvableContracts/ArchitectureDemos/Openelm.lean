-- Theorems for `contracts/inference-openelm-smoke-v1.yaml`.
--
-- OpenELM layer-wise scaling discriminator. The smoke recipe models `smoke()` and `forward_sim()`
-- as pure functions of their inputs; determinism and totality are
-- derivable from referential transparency.

namespace ProvableContracts.ArchitectureDemos.Openelm
...
end ProvableContracts.ArchitectureDemos.Openelm
