...
- **Composition**: [`examples/deployment-stacks/stacks/02-training/forjar.yaml`](https://github.com/paiml/apr-cookbook/blob/main/examples/deployment-stacks/stacks/02-training/forjar.yaml)
- **README**: [`examples/deployment-stacks/stacks/02-training/README.md`](https://github.com/paiml/apr-cookbook/blob/main/examples/deployment-stacks/stacks/02-training/README.md)
