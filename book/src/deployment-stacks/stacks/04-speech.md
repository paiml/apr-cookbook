...
- **Composition**: [`examples/deployment-stacks/stacks/04-speech/forjar.yaml`](https://github.com/paiml/apr-cookbook/blob/main/examples/deployment-stacks/stacks/04-speech/forjar.yaml)
- **README**: [`examples/deployment-stacks/stacks/04-speech/README.md`](https://github.com/paiml/apr-cookbook/blob/main/examples/deployment-stacks/stacks/04-speech/README.md)
