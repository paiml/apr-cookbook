...
- **Composition**: [`examples/deployment-stacks/stacks/03-rag/forjar.yaml`](https://github.com/paiml/apr-cookbook/blob/main/examples/deployment-stacks/stacks/03-rag/forjar.yaml)
- **README**: [`examples/deployment-stacks/stacks/03-rag/README.md`](https://github.com/paiml/apr-cookbook/blob/main/examples/deployment-stacks/stacks/03-rag/README.md)
