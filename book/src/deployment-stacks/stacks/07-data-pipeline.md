...
- **Composition**: [`examples/deployment-stacks/stacks/07-data-pipeline/forjar.yaml`](https://github.com/paiml/apr-cookbook/blob/main/examples/deployment-stacks/stacks/07-data-pipeline/forjar.yaml)
- **README**: [`examples/deployment-stacks/stacks/07-data-pipeline/README.md`](https://github.com/paiml/apr-cookbook/blob/main/examples/deployment-stacks/stacks/07-data-pipeline/README.md)
