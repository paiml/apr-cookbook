...
- **Composition**: [`examples/deployment-stacks/stacks/06-full-stack/forjar.yaml`](https://github.com/paiml/apr-cookbook/blob/main/examples/deployment-stacks/stacks/06-full-stack/forjar.yaml)
- **README**: [`examples/deployment-stacks/stacks/06-full-stack/README.md`](https://github.com/paiml/apr-cookbook/blob/main/examples/deployment-stacks/stacks/06-full-stack/README.md)
