...
- **Composition**: [`examples/deployment-stacks/stacks/01-inference/forjar.yaml`](https://github.com/paiml/apr-cookbook/blob/main/examples/deployment-stacks/stacks/01-inference/forjar.yaml)
- **README**: [`examples/deployment-stacks/stacks/01-inference/README.md`](https://github.com/paiml/apr-cookbook/blob/main/examples/deployment-stacks/stacks/01-inference/README.md)
